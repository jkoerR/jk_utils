...
//import com.dreamsolutech.openingbox.fcm.PushActivity;
...
//    public static void setNoti(Context ctxt, JsonObject jsonObject) {
...
//            builder.setSmallIcon(R.drawable.main_icon);  // 알림 왔을때 상단 작은 아이콘
